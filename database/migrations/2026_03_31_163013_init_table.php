...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // 3. Довідники та логістика (Parent Tables)
        ...
        Schema::create('promo_codes', function (Blueprint $table) {
            ...
            $table->decimal('value');
            $table->decimal('min_order_price')->nullable();
        ...
        Schema::create('drivers', function (Blueprint $table) {
            ...
            $table->string('status')->default('available'); // 'available', 'busy', 'unavailable'
